export const COPY = {
  ...
  survey: {
    ...
    nextRequiresAnswer: "현재 문항에 답변 후 다음으로 이동해 주세요.",
    submitError: "제출 중 오류가 발생했습니다.",
    domainGuideTitle: "영역 안내",
    domainGuideA: "A 이해: AI의 원리/한계 이해",
    domainGuideB: "B 활용: 업무에 AI를 적용하는 실천",
    domainGuideC: "C 비판적 검증: 사실 확인과 재구성",
    domainGuideD: "D 윤리와 책임: 개인정보/저작권/책임 의식",
  },
  ...
  likert: {
    labels: ["1 전혀 그렇지 않다", "2 그렇지 않다", "3 보통이다", "4 그렇다", "5 매우 그렇다"],
    descriptions: [
      "이 문장은 나와 전혀 맞지 않습니다.",
